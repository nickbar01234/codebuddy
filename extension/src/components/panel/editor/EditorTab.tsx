...
export const EditorTab = (props: TabProps) => {
  ...
  return (
    <div
      ...
      className="flex h-10 w-full items-center gap-x-2 data-[active=false]:hidden border-b p-1 border-[#0000000f] overflow-x-auto whitespace-nowrap justify-between"
    >
