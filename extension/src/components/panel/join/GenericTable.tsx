  ...
  return (
    <ScrollArea className="grow h-10 z-10">
      ...
      <SkeletonWrapper loading={data === undefined}>
        <Table className="min-w-full dark:bg-transparent dark:text-white">
          <TableHeader className="sticky top-0 bg-white dark:bg-[--color-tabset-tabbar-background] text-secondary dark:text-gray-300 z-20">
            <TableRow>
              {headers.map((header) => (
