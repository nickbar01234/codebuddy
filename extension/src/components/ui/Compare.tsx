    ...
    >
          ...
          {firstImage ? (
            ...
            >
              <img
                ...
                src={firstImage}
                className={
                  "absolute inset-0  z-20 rounded-2xl object-fill flex-shrink-0 w-full h-full select-none"
                }
                draggable={false}
              />
            </motion.div>
      ...
      <AnimatePresence initial={false}>
        {secondImage ? (
          <motion.img
            className={
              "absolute top-0 left-0 z-[19] object-fill rounded-2xl w-full h-full select-none"
            }
            alt="second image"
            src={secondImage}
            draggable={false}
